...
<head>
    ...
    <meta charset="utf-8">
    <link rel="icon" type="image/icon" href="home2.png" >
            ...
            <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="w-100" src="assets/img/homee3.jpg" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 800px;">
                                <h6 class="section-title text-white text-uppercase mb-3 animated slideInDown">SiSewa</h6>
                                <h1 class="display-3 text-white mb-4 animated slideInDown">Sewa Tanah & Bangunan</h1>
                                <a href="<?php echo base_url('produk');?>" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Sewa Sekarang</a>
                                </div>
                           
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img class="w-100" src="img/homee2.jpg" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Selamat Datang di <span class="text-primary text-uppercase">SiSewa</span></h1>
                        <p class="mb-4">Sisewa Merupakan website sewa aset yang dikembangkan oleh Dinas Pekerjaan Umum Bina Marga Provinsi Jawa Timur. Dengan menggunakan SiSewa memudahkan transaksi sewa menyewa. Di SiSewa menyewakan berbagai macam tanah kosong, tanah beserta bangunan yang bisa dipilih</p>
                            ...
                            <div class="col-sm-4 wow fadeIn" data-wow-delay="0.3s">
                                <div class="border rounded p-1">
                                    <div class="border rounded text-center p-4">
                                        <i class="fa fa-hotel fa-2x text-primary mb-2"></i>
                                        <h2 class="mb-1" data-toggle="counter-up">1234</h2>
                                        <p class="mb-0">Tanah & Bangunan</p>
                                    </div>
                                </div>
                            </div>
                            
                        </div>
                        <a class="btn btn-primary py-3 px-5 mt-2" href="<?php echo base_url('produk');?>""">Sewa Sekarang</a>
                    </div>
                    <div class="col-lg-6">
                        <div class="row g-3">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Kategori <span class="text-primary text-uppercase">Sewa Aset</span></h1>
                </div>
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <a class="service-item rounded" href="">
                            ...
                            <h5 class="mb-3">Tanah & Bangunan</h5>
                            <p class="text-body mb-0">Kami menyewakan tanah beserta bangunan yang dapat anda gunakan sebagai rumah tempat tinggal maupun sebagai Toko</p>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                        <a class="service-item rounded" href="">
                            <div class="service-icon bg-transparent border rounded p-1">
                                <div class="w-100 h-100 border rounded d-flex align-items-center justify-content-center">
                                    <i class="bi bi-map fa-2x text-primary"></i>
                                </div>
                            </div>
                            <h5 class="mb-3">Tanah Kosong</h5>
                            <p class="text-body mb-0">Kami juga menyewakan tanah kosong yang dapat anda manfaatkan </p>
                        </a>
                    </div>
